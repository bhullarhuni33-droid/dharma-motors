      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-info">
            ...
            <p className="stat-number">{dashboard?.active_jobs || 0}</p>
          </div>
        </div>
        <div className="stat-card">
          <span className="stat-icon">💰</span>
              ...
              <div className="modal-body">
                ...
                <form onSubmit={createInvoice}>
                  ...
                  <div className="modal-total">
                    ...
                    <strong>₹{(parseFloat(invoiceData.parts_cost) || 0) + (parseFloat(invoiceData.labour_cost) || 0) + (parseFloat(invoiceData.diagnostics_cost) || 0)}</strong>
                  </div>
      ...
      <div className="card">
        ...
        <form onSubmit={createReward} className="walkin-form">
          ...
          <textarea
            ...
            rows="2"
            style={{ width: '100%', padding: '10px', border: '2px solid #e8e8e8', borderRadius: '8px' }}
          />
          <input
            type="number"
        ...
        {rewardsCatalog.length === 0 ? (
          ...
          rewardsCatalog.map(r => (
            <div key={r.id} className="list-item">
              ...
              <p>{r.description}</p>
              <p style={{ fontWeight: 'bold', color: '#667eea' }}>⭐ {r.points_required} points</p>
